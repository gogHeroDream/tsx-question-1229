declare namespace AMap {
    ...
    **/
    ...
    export class Map {
        ...
        constructor(container: string | HTMLDivElement, opts: IMapOptions);
    ...
    /** View2DOptions **/
    export interface IView2DOptions {
        /**地图中心点坐标值**/
        center?: LngLat;
    ...
    /** MarkerShapeOptions **/
    export interface IMarkerShapeOptions {
    ...
    export interface IElasticMarkerOptions {
        /**多个不同样式的数组, 每个样式形如:
        *{
        * icon: {
        * img: './a, png',
    ...
    export class ElasticMarker {
        ...
        constructor(opt: IElasticMarkerOptions);
        /**唤起高德地图客户端标注页其中Object里面包含有{ name: String, name属性 必要参数 position:
        * LngLat 坐标点 }**/
        public markOnAMAP(obj: any): void;
    ...
    export class Polyline {
        ...
        constructor(opt: IPolylineOptions);
        /**设置组成该折线的节点数组**/
        ...
        public setOptions(opt: IPolylineOptions): void;
    ...
    export class Polygon {
        ...
        constructor(opt: IPolygonOption)
        ...
        public setOptions(opt: IPolygonOption): void;
     ...
     * InfoWindow配置项接口
     */
    export interface IInfoWindowOption {
    ...
    export class InfoWindow {
        ...
        constructor(opt: IInfoWindowOption);
